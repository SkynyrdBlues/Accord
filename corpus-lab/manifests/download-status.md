...
| ChoCo | repo_scripted_not_started | 仓库下载脚本已写好，正式使用建议优先选择 release/subset。 |
| PDMX | repo_scripted_not_started | 仓库下载脚本已写好，完整数据应从 Zenodo 选择 `no_license_conflict` / `all_valid` 子集。 |
| GiantMIDI-Piano | repo_scripted_not_started | 仓库下载脚本已写好，稳定数据下载需要人工阅读并接受 disclaimer。 |
